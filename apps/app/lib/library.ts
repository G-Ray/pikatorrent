...
export const library = [
  {
    ...
    image:
      Platform.OS === 'web'
        ? '/cosmos-laundromat.jpg'
        : require('../public/cosmos-laundromat.jpg'),
    description:
  ...
  },
  {
    ...
    image:
      Platform.OS === 'web'
        ? '/tears-of-steel.png'
        : require('../public/tears-of-steel.png'),
    size: 558080000,
  },
  {
    title: 'Sintel',
    ...
    image:
      Platform.OS === 'web' ? '/sintel.jpg' : require('../public/sintel.jpg'),
    size: 126336000,
  },
  {
    title: 'Big Buck Bunny',
    description:
      'Tired of being picked on by Frankie the squirrel and his band of puny forest creatures, JC the bunny finally decides to fight back.',
    url:
      '/add#magnet=' +
      encodeURIComponent(
    ...
    image:
      Platform.OS === 'web'
        ? '/big-buck-bunny.jpg'
        : require('../public/big-buck-bunny.jpg'),
    size: 270080000,
  },
]

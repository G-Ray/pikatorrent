...
export default function FAQ() {
  return (
    ...
    <YStack space mt="$8" px="$8" pb="$16" maxWidth={800}>
      ...
      <Paragraph>
        PikaTorrent is a cross-platform and open source Bittorrent client. It is
        currently available for Android, Linux, and Windows. A MacOS & iOS app
        might arrive later.
      </Paragraph>
      ...
      <Paragraph>
        ...
        With PikaTorrent, we try to offer the tools to redecentralize our files
        shares. BitTorrent is a very efficient protocol to share files. By using
        BitTorrent, PikaTorrent offers:
        <ul>
          <li>
      ...
      <Paragraph>
        uTorrent (and the BitTorrent client from the same company) has gained a
        bad reputation over time by installing toolbars, displaying ads and
        ...
        PikaTorrent even uses the same engine as Transmission: libtransmission.
      </Paragraph>
      <Paragraph>
        ...
        If you would like to request features missing in PikaTorrent, you can do
        so on{' '}
        <Link
      ...
      <Paragraph>
        ...
        Once you confirm the connection from the desktop app, you should be able
        to control your desktop app from the mobile app. You don't need to
        register for an account, and the connection is secured with end-to-end
        encryption, thanks to WebRTC. Please note this might not work behind
        some restricted networks.
      </Paragraph>
      ...
      <Paragraph>
        ...
        <Link href="https://www.npmjs.com/package/pikatorrent" target="_blank">
          npmjs.com
        </Link>
      </Paragraph>
